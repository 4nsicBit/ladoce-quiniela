...
# 1. Extraer Predictions como componente externo antes de App
...
print("Extract Predictions:", "OK" if old_pred in content else "NO ENCONTRADO")
content = content.replace(old_pred, new_pred)

# 2. Cambiar el uso de Predictions en el render para pasar props
old_render = '{view==="predictions" && <Predictions/>}'
new_render = '''{view==="predictions" && <Predictions
            ...
            t={t} lang={lang}
          />}'''
print("Fix render:", "OK" if old_render in content else "NO ENCONTRADO")
